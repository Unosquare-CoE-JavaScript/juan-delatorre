...
export const updateTask = createAction('[Task/API] Update Task', props<{ task: Update<Task> }>())
...
export const updateTasks = createAction('[Task/API] Update Tasks', props<{ tasks: Update<Task>[] }>())
